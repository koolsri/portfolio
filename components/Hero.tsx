        ...
        <div className="relative mx-auto md:mr-0">
          <div className="w-64 h-64 md:w-80 md:h-80 relative">
            ...
            <img
              src={PROFILE_IMAGE}
              alt="Profile"
              className="relative w-full h-full object-cover object-top rounded-3xl border-2 border-white dark:border-slate-700 shadow-2xl transition-transform duration-500"
            />
          </div>
        </div>
      </div>
